  ...
  template: `
    ...
    <section class="relative min-h-[90vh] flex items-center justify-center pt-24 pb-16 bg-gradient-to-br from-reasons-navy via-[#0a3246] to-reasons-green overflow-hidden">
      ...
      <div class="absolute inset-0 opacity-15">
        ...
        <div class="absolute -bottom-40 -right-40 w-96 h-96 rounded-full bg-reasons-gold filter blur-3xl"></div>
      </div>
      ...
      <div class="relative max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div class="lg:col-span-7 flex flex-col gap-6 text-left">
          ...
          <p class="text-lg text-slate-200 font-light leading-relaxed max-w-2xl">
            Impulsamos la excelencia en investigación multidisciplinaria uniendo la optimización de procesos industriales, el desarrollo tecnológico computacional, la armonía con la naturaleza y el beneficio de la sociedad.
          </p>
        ...
        <div class="lg:col-span-5 flex justify-center">
          <div class="glass-dark-card p-8 rounded-3xl flex flex-col items-center gap-6 max-w-md w-full text-center hover-premium glowing-card animate-float">
            <div class="w-32 h-32 rounded-full bg-white p-4 flex items-center justify-center shadow-xl">
              <img src="/logo.svg" alt="REASONS Group Logo" class="h-24 w-auto object-contain" />
            </div>
    ...
    <section class="py-24 bg-white bg-grid-pattern relative">
      <div class="max-w-7xl mx-auto px-6">
        ...
        <!-- Interactive Tabs for Objectives -->
        <div class="max-w-5xl mx-auto">
          <!-- Tab headers -->
          <div class="flex border-b border-slate-100 justify-center mb-8">
            <button (click)="selectTab('mision')" 
                    [class]="activeTab === 'mision' ? 'tab-btn active-tab' : 'tab-btn'">
              Nuestra Misión
            </button>
            <button (click)="selectTab('general')" 
                    [class]="activeTab === 'general' ? 'tab-btn active-tab' : 'tab-btn'">
              Objetivo General
            </button>
            <button (click)="selectTab('especificos')" 
                    [class]="activeTab === 'especificos' ? 'tab-btn active-tab' : 'tab-btn'">
              Objetivos Específicos
            </button>
          </div>

          <!-- Tab Content -->
          <div class="glass-card p-8 md:p-12 rounded-3xl min-h-[250px] shadow-lg animate-fade-in glowing-card">
            <!-- Misión Content -->
            <div *ngIf="activeTab === 'mision'" class="flex flex-col gap-6 animate-fade-in">
              <h3 class="text-2xl font-bold text-reasons-navy flex items-center gap-3">
                <svg class="h-6 w-6 text-reasons-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path>
                </svg>
                Comprometidos con el Desarrollo Multidisciplinario
              </h3>
              <p class="text-slate-600 leading-relaxed text-base font-light">
                Generar, promover y difundir conocimiento científico y tecnológico de vanguardia e impacto multidisciplinario, articulando la ingeniería avanzada con procesos de sostenibilidad industrial y ambiental, para aportar con soluciones innovadoras a las problemáticas actuales de la naturaleza y el beneficio de la sociedad andina y global.
              </p>
            </div>

            <!-- Objetivo General Content -->
            <div *ngIf="activeTab === 'general'" class="flex flex-col gap-6 animate-fade-in">
              <h3 class="text-2xl font-bold text-reasons-navy flex items-center gap-3">
                <svg class="h-6 w-6 text-reasons-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Objetivos Específicos Content -->
            <div *ngIf="activeTab === 'especificos'" class="flex flex-col gap-6 animate-fade-in">
              <h3 class="text-2xl font-bold text-reasons-navy flex items-center gap-3 mb-2">
                <svg class="h-6 w-6 text-reasons-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                </svg>
                Acciones Estratégicas del Grupo
              </h3>
              <ul class="grid grid-cols-1 md:grid-cols-2 gap-4 text-slate-600 font-light text-sm">
                <li class="flex items-start gap-3 p-3 rounded-xl hover:bg-slate-50">
                  <span class="flex h-5 w-5 items-center justify-center rounded-full bg-reasons-green/10 text-reasons-green font-bold text-xs">1</span>
                  <span>Publicar artículos científicos de alta calidad en revistas indexadas internacionalmente (Scopus, WoS).</span>
                </li>
                <li class="flex items-start gap-3 p-3 rounded-xl hover:bg-slate-50">
                  <span class="flex h-5 w-5 items-center justify-center rounded-full bg-reasons-green/10 text-reasons-green font-bold text-xs">2</span>
                  <span>Desarrollar proyectos piloto conjuntos con industrias metalmecánicas, textiles y ambientales de la región.</span>
                </li>
                <li class="flex items-start gap-3 p-3 rounded-xl hover:bg-slate-50">
                  <span class="flex h-5 w-5 items-center justify-center rounded-full bg-reasons-green/10 text-reasons-green font-bold text-xs">3</span>
                  <span>Formar investigadores jóvenes de pregrado y posgrado mediante la tutoría de tesis de excelencia.</span>
                </li>
                <li class="flex items-start gap-3 p-3 rounded-xl hover:bg-slate-50">
                  <span class="flex h-5 w-5 items-center justify-center rounded-full bg-reasons-green/10 text-reasons-green font-bold text-xs">4</span>
                  <span>Integrar hardware y software inteligente (IoT, AI) aplicados al desarrollo ecológico y optimización de recursos.</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="max-w-7xl mx-auto px-6">
        <div class="text-center max-w-4xl mx-auto flex flex-col gap-4 mb-16">
          ...
          <p class="text-slate-500 font-light max-w-3xl mx-auto leading-relaxed">
            Nuestro dominio oficial abarca la <strong class="text-reasons-blue font-semibold">Optimización de los Sistemas Productivos, Diseño y Desarrollo Urbanístico de la Facultad de Ingeniería en Sistemas, Electrónica e Industrial</strong> de la Universidad Técnica de Ambato.
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <!-- Line 1 -->
          <div id="linea-1" class="glass-card p-8 rounded-3xl flex flex-col gap-6 hover-premium glowing-card">
            ...
            <div class="flex flex-col gap-2">
              <span class="text-xs font-bold text-reasons-green tracking-widest uppercase">Línea 1 (DMP-IST)</span>
              <h3 class="text-xl font-bold text-reasons-navy">Diseño, Materiales, Producción y Sostenibilidad</h3>
            </div>
            <p class="text-slate-500 font-light text-sm leading-relaxed">
              Enfocada en el desarrollo de nuevos materiales ecológicos, ecodiseño de productos, ergonomía industrial, y la reestructuración de estaciones de trabajo para reducir desperdicios de manufactura.
            </p>
          </div>

          <!-- Line 2 -->
          <div id="linea-2" class="glass-card p-8 rounded-3xl flex flex-col gap-6 hover-premium glowing-card">
            <div class="w-14 h-14 rounded-2xl bg-reasons-blue/10 flex items-center justify-center text-reasons-blue">
              <svg class="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
              </svg>
            </div>
            <div class="flex flex-col gap-2">
              <span class="text-xs font-bold text-reasons-blue tracking-widest uppercase">Línea 2 (ST-ICD)</span>
              <h3 class="text-xl font-bold text-reasons-navy">Software, Tecnologías e Inteligencia de Datos</h3>
            </div>
            <p class="text-slate-500 font-light text-sm leading-relaxed">
              Dedicada al desarrollo de arquitecturas de software de alto desempeño, implementación de IoT, analítica predictiva mediante Machine Learning y big data para automatización inteligente.
            </p>
          </div>
          ...
          <div id="linea-3" class="glass-card p-8 rounded-3xl flex flex-col gap-6 hover-premium glowing-card">
            ...
            <p class="text-slate-500 font-light text-sm leading-relaxed">
              Investigación en la eficiencia de micro-redes eléctricas, modelado estocástico de energía renovable distribuida (fotovoltaica/solar), y la gestión limpia del agua e impacto ecológico.
            </p>
          </div>
        </div>
      </div>
...
export class HomeComponent implements OnInit, OnDestroy {
  ...
  selectTab(tab: 'mision' | 'general' | 'especificos') {
    this.activeTab = tab;
    this.cdr.detectChanges();
    this.startRotation(); // Reiniciar el temporizador para dar 5 segundos completos
  }
}
